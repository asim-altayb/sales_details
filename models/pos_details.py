...
class PosDetails(models.TransientModel):
    ...
    products=fields.Many2one('product.product')
    ...
    def generate_report(self):
        ...
        data = {'date_start': self.start_date, 'date_stop': self.end_date, 'config_ids': self.pos_config_ids.ids,'products':self.products.ids}
